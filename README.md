...
[Hystreet (activity of pedestrians in a city) as color (yellow - many, red - a few), covid-19 case growth 7 days later (circle size):](https://kepler.gl/demo?mapUrl=https://raw.githubusercontent.com/ManuelB/covid-19-vis/gh-pages/germany/everyonecounts/everycounts-hystreet_score-7-days-case-growth-keplergl.json)
